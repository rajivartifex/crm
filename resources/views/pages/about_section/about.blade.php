                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{route('customer-business-category-index')}}" class="btn btn-primary btn-sm">View</a>
                                    <button type="button" class="btn btn-sm btn-primary dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
                                    <div class="dropdown-menu" role="menu">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{route('customer-working-hours-index')}}" class="btn btn-primary btn-sm">View</a>
                                    <button type="button" class="btn btn-sm btn-primary dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
                                    <div class="dropdown-menu" role="menu">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{route('customer-description-index')}}" class="btn btn-primary btn-sm">View</a>
                                    <button type="button" class="btn btn-sm btn-primary dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
                                    <div class="dropdown-menu" role="menu">
