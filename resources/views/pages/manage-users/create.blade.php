@extends('layouts.app')
@section('title')
@if(!empty($user)) User Edit: {{$user->id}} @else New User @endif
@endsection
@section('style')
<!-- Select2 -->
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4>@if(!empty($user)) User Edit: {{$user->id}} @else New User @endif</h4>
            </div>
            <div class="col-sm-6">
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">@if(!empty($user)) User Edit @else New User @endif</h3>
    </div>
