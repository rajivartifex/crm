            ...
            <form class="business-web-form">
                <div class="card-body">
                        ...
                        @foreach ($custWebs as $key => $list)
                            <div class="col-sm-12">
                                <div class="row web_link_wrapper align-items-end">
                                    <input type="hidden" name="ff[web_id]" class="web_id"
                                        value="{{ $list->id }}" />
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <label>Media Name</label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="ff[cust_media_name]" value="{{ $list->cust_media_name ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="ff[cust_media_link]" value="{{ $list->cust_media_link ?? '' }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    data-id="{{ $list->id ?? '' }}" onclick="$(this).specialDelete();"><i
                                ...
                                <div class="row web_link_wrapper align-items-end">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <label>Media Name</label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="ff[cust_media_name]" value="{{ $arr[$i] }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group">
                    ...
                    @can('social-media-edit')
                        <div class="col-sm-12">
                            <div class="form-group">
                                <a class="btn-sm btn btn-secondary add_web_link_btn float-right"><i class="fas fa-plus"></i>
                                    Social Media</a>
                            </div>
                        </div>
                    @endcan
