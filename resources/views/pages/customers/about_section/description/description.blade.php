@extends('layouts.app')
@section('title')
    {{ $custDesc ? 'Edit Description' : 'Add Description' }}
@endsection
@section('style')
@endsection
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>{{ $customer->cust_business_name ?? '' }} | Description | {{ $custDesc ? 'Edit' : 'Add' }}</h4>
                </div>
                <div class="col-sm-6">
    ...
    <div class="card card-primary">
        ...
        <form class="business-description-form">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-secondary btn-sm business-description-submit">Submit</button>
