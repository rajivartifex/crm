<script>
    ...
    $(".payment-modal-form").submit(function(e){
        ...
        $.ajax({
            ...
            success:function(response){
                location.href = "{{url('settings/payment-form')}}" + "?pay_id=" + response.data.id;
            }
        })
    });
    ...
    $(".solution-modal-form").submit(function(e){
        ...
        $.ajax({
            ...
            processData: false,
            success:function(response){
                location.href = "{{url('settings/solution-form')}}" + "?sol_id=" + response.data.id;
            }
        })
    });
    ...
    $(".payment-mode-modal-form").submit(function(e){
        ...
        $.ajax({
            ...
            processData: false,
            success:function(response){
                location.href = "{{url('settings/paymentmode-form')}}" + "?pay_mode_id=" + response.data.id;
            }
        })
    });
    ...
    $(".marketing-modal-form").submit(function(e){
        ...
        $.ajax({
            ...
            processData: false,
            success:function(response){
                location.href = "{{url('settings/marketing-form')}}" + "?mark_id=" + response.data.id;
            }
        })
    });
});
