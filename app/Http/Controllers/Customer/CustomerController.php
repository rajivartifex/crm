...
class CustomerController extends Controller
{
    ...
    public function reportIndex(Request $request)
    {
            $domain_rec = DB::table('cust_domain_rec__tbl')
                ->select('cust_id', 'cust_domain_name', 'cust_domain_renewal_date', 'cust_business_name')
            ...
            $subscription_rec = DB::table('cust_subscription_rec__tbl')
                ->select('cust_id', 'cust_sub_website_name', 'cust_sub_renewal_date', 'type', 'cust_business_name')
            ...
            $marketing_rec = DB::table('cust_marketing_rec__tbl')
                ->select('cust_id', 'cust_mark_domain_name', 'cust_mark_renewal_date', 'type', 'cust_business_name')
            ...
            $support_rec = DB::table('cust_support_rec__tbl')
                ->select('cust_id', 'cust_sup_product_name', 'cust_sup_renewal_date', 'type', 'cust_business_name')
